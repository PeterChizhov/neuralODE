...
# Augmented NeuralODE : https://github.com/EmilienDupont/augmented-neural-odes
...
class ODEFunc(nn.Module):
    ...
    def __init__(self, device, data_dim, hidden_dim, augment_dim=0,
                 time_dependent=False, non_linearity='tanh'):     # was relu, tanh added
...
class simpleRNN(nn.Module):
    def __init__(self, device, data_dim, hidden_dim, augment_dim=0, non_linearity='tanh', timesteps_count=2):
        super().__init__()
    ...
    def forward(self, x):
        ...
        for i in range(self.timesteps_count):
            ...
            x_in = self.fc3(x) + x_in
        return x_in
    
# we can use this ODE_block as is and watch only 2 first elements as output
class ODEBlock(nn.Module):
    ...
    """
    def __init__(self, device, odefunc, is_conv=False, tol=1.5e-8, adjoint=False, method='dopri5'): # tol was 1e-3
